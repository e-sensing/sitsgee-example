...
This repository showcases reproducible comparisons of the sits R package and the
Google Earth Engine.
...
Next, open the `sits-gee` directory in the RStudio and install the examples
package:
